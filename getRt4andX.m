...
% 得到第三组匹配（图像3和图像4）中图像4的匹配点的索引和3D坐标的对应
...
% 找到第四组匹配中图像4匹配点与第三组匹配中图像4匹配点相同的索引
% 注意：这里是从求Rt3时，新建的3D点所对应的第三组匹配中图像4匹配点索引中寻找，与计算相机4外参的有所区别
...
% 筛选出第四组匹配中已知3D点的匹配点索引，并将其与对应的三维点一一对应存储
